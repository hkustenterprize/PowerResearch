...
#define LINE_ADC_MOTOR1             PAL_LINE(GPIOC, 2U)
#define LINE_ADC_MOTOR2             PAL_LINE(GPIOC, 3U)
#define LINE_ADC_MOTOR3             PAL_LINE(GPIOC, 4U)
#define LINE_ADC_MOTOR4             PAL_LINE(GPIOC, 5U)
